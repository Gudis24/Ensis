...
<div class="container">
  <section class="patternBar">
    <?php if($mission['tytul']): ?>
      <h2><?php echo $mission['tytul']; ?></h2>
    <?php endif; ?>
  </section>
  <section class="siteWidth">
    <div class="cards flexing">
     <?php
      if( have_rows('mission') ): // grupa
