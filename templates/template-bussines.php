<?php
/**
 * Template Name: Bussines Consulting
...
<section class="patternBar">
  <?php if($audit['tytul']): ?>
    <h2><?php echo $audit['tytul']; ?></h2>
  <?php endif; ?>
</section>
<section class="siteWidth widthAudit">
  <div class="cards audit flexing">
   <?php
    if( have_rows('audit') ): // grupa
      while( have_rows('audit')): the_row();?>
        <?php if( have_rows('karta') ) : // repeater ?>
            ...
            <?php while( have_rows('karta') ) : the_row();
              ...
              ?>
              <div class="card">
                <div class="cardWrapper auditWrapper">
